...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	...
	$("#saveActivityBtn").click(function () {
		//收集参数
		var owner = $("#create-marketActivityOwner").val(); //所有者
		var name = $.trim($("#create-marketActivityName").val()); //市场活动名称
		var startDate=$("#create-startDate").val(); //开始日期
		var endDate=$("#create-endDate").val(); //结束日期
		var cost=$.trim($("#create-cost").val()); //成本
		var description=$.trim($("#create-description").val()); //描述
					...
					<div class="form-group">
						...
						<div class="col-sm-10" style="width: 300px;">
							<select class="form-control" id="create-marketActivityOwner">
								<c:forEach items="${userList}" var="u"> <%--在jstl标签中，获取数据都用el表达式${xxxx}--%>
